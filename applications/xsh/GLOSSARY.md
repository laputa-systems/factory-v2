# XSH application glossary

## Status and use

This file is the canonical vocabulary for the XSH application. The repository
root [`ARCHITECTURE.md`](../../ARCHITECTURE.md) defines the generic apparatus;
[`ARCHITECTURE.md`](ARCHITECTURE.md) defines this application's composition;
and [`VERTICAL-SLICE.md`](VERTICAL-SLICE.md) defines its executable proof.
XSH application Rust types, fixtures, evaluators, projections, and prompts use
the spellings here. A synonym in prose does not create a new domain concept.
